...
@interface HYShoesVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *dataArray;
@end
static NSString *ID = @"cell";
@implementation HYShoesVC
...
- (void)loadData
{
    [HYNetworking getWithUrl:ShoesURL refreshCache:YES params:nil success:^(id response) {
        HYLog(@"data ===   %@",response);
