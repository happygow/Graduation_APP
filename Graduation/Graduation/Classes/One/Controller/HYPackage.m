...
@interface HYPackage ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *dataArray;
@end
static NSString *ID = @"cell";
@implementation HYPackage
...
- (void)loadData
{
    [HYNetworking getWithUrl:PackageURL refreshCache:YES params:nil success:^(id response) {
        HYLog(@"data ===   %@",response);
