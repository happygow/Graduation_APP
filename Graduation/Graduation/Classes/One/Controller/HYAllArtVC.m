...
@interface HYAllArtVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSMutableArray *dataArray;
@end
static NSString *ID = @"cell";
@implementation HYAllArtVC
...
- (void)loadData
{
    [HYNetworking getWithUrl:allArtURL refreshCache:YES params:nil success:^(id response) {
        HYLog(@"data ===   %@",response);
